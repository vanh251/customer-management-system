// ============================================================
// ============================================================
// Quản Lý Thanh Toán - Xử lý dữ liệu jQuery AJAX
// ============================================================
$(document).ready(function () {
    ...
    // ---- Hàm hỗ trợ: Định dạng ngày tháng giờ phút ----
    function formatDate(s) {
        if (!s) return '-';
        const d = new Date(s);
        return d.toLocaleDateString('en-GB', { day: '2-digit', month: 'short' }) + ', ' + d.toLocaleTimeString('en-GB', { hour: '2-digit', minute: '2-digit' });
    }
    // ---- Hàm hỗ trợ: Tạo badge trạng thái thanh toán HTML ----
    function badge(st) {
    ...
    // Gọi API để tải danh sách thanh toán dựa trên các bộ lọc
    ...
    // Hiển thị danh sách thanh toán ra bảng HTML
    ...
    // Hiển thị phân trang cho bảng thanh toán
    ...
    // ============================================================
    // Trình xử lý các nút hành động (Xóa thanh toán, ...)
    // ============================================================
